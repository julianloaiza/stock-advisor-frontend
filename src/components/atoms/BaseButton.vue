...
export default defineComponent({
  ...
  setup(props) {
    const getButtonClasses = computed(() => {
      ...
      // Clases base comunes
      const baseClasses =
        'font-medium rounded-lg text-center focus:outline-none focus:ring-4 disabled:opacity-50 disabled:cursor-not-allowed'
      ...
      switch (props.variant) {
        ...
        case 'icon':
          return 'inline-flex items-center text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400'
        case 'link':
          return 'bg-transparent border-0 p-0 focus:outline-none text-sm hover:underline'
        default:
          return `${baseClasses} ${sizeClass} text-white bg-blue-700 hover:bg-blue-800 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800`
      }
    })
